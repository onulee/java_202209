...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='fboard',
            name='b_date',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2022, 10, 5, 16, 11, 9, 83864)),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 10, 5, 16, 11, 9, 83864))),
